...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  encryptRSA: (data, publicKey) => ipcRenderer.invoke('crypto:encrypt-rsa', { data, publicKey }),
  decryptRSA: (data, privateKey) => ipcRenderer.invoke('crypto:decrypt-rsa', { data, privateKey }),
});
